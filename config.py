...
OWNER_USERNAME = getenv("OWNER_USERNAME","Usesense")
BOT_USERNAME = getenv("BOT_USERNAME" , "LinuxMusikbot")
BOT_NAME = getenv("BOT_NAME" , "Shizuka")
ASSUSERNAME = getenv("ASSUSERNAME" , "ShizukaMusics")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1002610492102))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/musicbhai/Bestie",)
